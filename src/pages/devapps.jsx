       ...
       <p style={{ color: 'white' }}>
          ...
          <p style={{ color: 'white' }}>
            <label>
              ...
              <textarea name="Experience In All Round Development" style={{ width: '75%' }} onChange={this.handleChange} />
            </label>
          </p>
                <p style={{ color: 'white' }}>
            <label>
          ...
          <p style={{ color: 'white' }}>
            <label>
             Please Provide Proof Of Said Experience/Work:<br />
              <textarea name="Proof Of Experience" style={{ width: '75%' }} onChange={this.handleChange} />
            </label>
          </p>
          <p>
