        ...
        >
         ...
         <p style={{ color: 'white' }}>
            <label>
              ...
              <input type="text" name="Why Are You Applying For This Department" style={{ width: '75%' }} onChange={this.handleChange} />
            </label>
          </p>
          <p style={{ color: 'white' }}>
            <label>
              What Can You Bring To This Department?:<br />
              <textarea name="What Can You Bring To This Department" style={{ width: '75%' }} onChange={this.handleChange} />
            </label>
          </p>
          <p style={{ color: 'white' }}>
            <label>
            ...
            <label>
              ...
              <textarea name="First 5 Things You Will Do If Accepted" style={{ width: '75%' }} onChange={this.handleChange} />
            </label>
          </p>
           <p style={{ color: 'white' }}>
            <label>
           ...
           <p style={{ color: 'white' }}>
            <label>
              ...
              <textarea name="Removal Agreement" style={{ width: '75%' }} onChange={this.handleChange} />
            </label>
          </p>
          <p>
