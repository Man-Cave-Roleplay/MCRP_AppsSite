          ...
          <p style={{ color: 'white' }}>
            ...
            <label>
             Discord Username And Tag Of The Staff Member You Are Reporting :<br />
              <textarea name="Discord Username Of Staff Member Who Has Been Reported" style={{ width: '75%' }} onChange={this.handleChange} />
            </label>
          </p>
                <p style={{ color: 'white' }}>
            <label>
              Whitnesses Usernames If Non State None:<br />
              <textarea name="Whitnesses State None If None Seen" style={{ width: '75%' }} onChange={this.handleChange} />
            </label>
          </p>
          <p style={{ color: 'white' }}>
            <label>
            What Did They Do Please Answer In Detail?:<br />
              <textarea name="What Did The Reported Staff Member Do" style={{ width: '75%' }} onChange={this.handleChange} />
            </label>
          </p>
          <p style={{ color: 'white' }}>
            <label>
              Evidence Of What They Did?:<br />
              <textarea name="Evidence" style={{ width: '75%' }} onChange={this.handleChange} />
            </label>
          </p>
                <p style={{ color: 'white' }}>
            <label>
            What Punishment Do You Recommend They Get For Doing What They Did?:<br />
              <textarea name="Reccomended Punishment" style={{ width: '75%' }} onChange={this.handleChange} />
            </label>
          </p>
                <p style={{ color: 'white' }}>
            <label>
              Do You Understand By Pressing Submit You Accept Our TOS/Rules:<br />
              <textarea name="tos/rules agreement" style={{ width: '75%' }} onChange={this.handleChange} />
            </label>
          </p>
          <p>
