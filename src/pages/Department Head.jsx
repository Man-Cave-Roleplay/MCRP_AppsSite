...
export default class Contact extends React.Component {
  ...
  handleSubmit = e => {
    ...
    fetch("/", {
      method: "POST",
      headers: { "Content-Type": "Department Head Application/x-www-form-urlencoded" },
      body: encode({
  ...
  render() {
    return (
      <div>
        <h1 style={{ color: 'white' }}>Department Head Application</h1>
        <form
          name="application"
          method="post"
          action="/thanks/"
        ...
        >
          ...
          <p style={{ color: 'white' }}>
            <label>
              Do you have any experience in Running A Department? If so please provide some proof:<br />
